...
#set outline()
#show raw: set text(font: ("Rec Mono Duotone", "Source Han Sans K"), size: 7pt)
...
인공 신경망은 이러한 발상에서 비롯한 기술이자 자료구조로, 일종의 그래프이다. 정점은 뉴런의 신경세포체#footnote[그냥 뉴런 자체를 의미한다고 하기도 한다.]를, 간선은 축삭을 본따 그 역할을 대신한다고 하는데, 생명과학을 배운 입장에서 이게 정말 맞는 말은 아닌 것 같고, 일반인들의 이해를 돕기 위한 비유적 설명으로 받아들일 수 있을 것이다.
