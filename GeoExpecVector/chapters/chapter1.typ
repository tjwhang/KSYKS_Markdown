...
$
  xx_parallel = (xx^TT uu_1) uu_1 = (1/sqrt(n) sum x_i) (1/sqrt(n) vbu(1)) = (1/n sum x_i) thin vbu(1)
$
...
확률벡터 $pp$도 똑같이 하자.
$
  pp_parallel &= (pp^TT uu_1) thin uu_1 = (1/sqrt(n) sum p_i)(1/sqrt(n) thin vbu(1)) \
  & = (1/sqrt(n) dot 1) (1/sqrt(n) thin vbu(1)) = 1/n thin vbu(1) = vec(1\/n, dots.v, 1\/n) \
  & because sum p_i = 1
$
