...
#let setup-rules(body) = {
    // [A] 기본 텍스트
    set text(size: 11pt, font: font-main, cjk-latin-spacing: none, lang: "ja", region: "KR")

    // [B] 문단 설정
    set par(first-line-indent: (amount: 1em, all: true), justify: true, leading: 1.414em, spacing: 1.618em)
    ...
    show math.equation: set text(
        font: (
            ...
            *   **포함 기호:** $\partial$ (편미분), $\nabla$, $\Delta$, $\infty$, $\int$ (적분), $\iint$, $\iiint$, $\oint$
                      ***/
            (name: "stix two math", covers: regex("[0-9 A-Z 𝐴-𝑍 ]")),
            (name: "XITS Math", covers: regex("[𝑥𝑦𝑘𝑧 𝛼 𝛽 𝜃 𝜋 𝜏 ∞ () \[\]]")), // special greek
            (name: "xits math", covers: regex("[a-z A-Z 𝑎-𝑧 \u{210E} ℎℏ]")), // normal latin
            ...
            (
                ...
                covers: regex(
                    "[ \\+ \\-−=×÷±∓∗/%<>≤≥≠≈≡∝ 𝐀-𝐙 \u{2295}-\u{229A}\u{2218}\u{22C6}\u{22C5} \u{2200}-\u{220B}\u{2223}-\u{222A}\u{2282}-\u{228B}\u{2227}\u{2228}\u{2201}-\u{2204}]",
                ),
            ), // operators
            (name: "STIX Two Math"),
            (name: "KoPubWorldBatang_Pro", covers: regex("[\p{scx:Hangul}+]")),
    ...
    // show raw.where(block: true): set par(leading: 1.2em)
