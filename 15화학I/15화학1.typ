...
#emph-box[
  ...
  2. $rho prop M$
  3. $n/V$는 일정
  4. 단위 부피 당 원자 수 #sym.arrow 분자당 원자 수 비교
  5. 단위 질량 당 분자 수 #sym.prop 1 / 분자량
  6. 단위 질량 당 원자 수 #sym.prop 분자 당 구성 원자 수 / 분자량
  7. 1 g 당 분자 수 #sym.times 질량 = 분자 수
  8. 단위 질량 당 부피 #sym.prop 1 / 밀도 #sym.prop 1 / 분자량

]

사실 조금만 생각하면 당연한 내용들이지만, 문제를 풀 때는 당연한 것도 떠올리는데 드는 시간도 아깝기 때문에 이왕이면 외우거나 문제를 풀며 체화시키도록 한다.
#pagebreak(weak: true)
