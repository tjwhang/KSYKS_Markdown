...
#let author-name = "이창용 선생님 수학 전집"
#let affiliation = "황태준 譯"
#let accent-color = rgb("#1d396c")
...
#show heading: it => {
    ...
    if it.level == 1 {
        ...
        v(1em)
        block(spacing: 0.8em, {
            stack(dir: ltr, spacing: 0.6em, text(fill: c-navy, weight: "black", size: 1.3em, font: "Libertinus Serif", "§"), text(
...
#chapter-cover(
  number: "1", title: "수열의 극한", 
  description: "[(수학 Ⅰ)]에서 공부한 수열은 정의역이 자연수인 함수였다. 따라서 수열의 극한은 함수의 극한이 축소된 개념이라고 생각해도 좋다. 수열의 극한과 그 합의 극한인 급수에 대해 자세히 알아보자.",
  sections: ("수열의 극한", "급수"),
)
...
#chapter-cover(
  number: "2", title: [미분법], 
  description: "[(수학Ⅰ)]에서 공부했던 지수함수, 로그함수, 삼각함수 등을 심화하여 극한과 미분 등에 대한 내용을 알아보고 이외에도 함수를 미분하는 다양한 방법에 대해 알아본다.",
  sections: ([지수함수와 로그함수의 \ 극한과 미분], "삼각함수의 극한과 미분", "여러 가지 미분법", "도함수의 활용"),
)
...
#chapter-cover(
  number: "3", title: [적분법], 
  description: "이번 단원에서는 [(수학 Ⅰ)]에서 공부한 삼각함수를 더욱 심화하여, 새로운 삼각함수들을 정의하고 삼각함수의 극한, 새로운 성질과 미분 등을 살펴본다.",
  sections: ("수열의 수렴과 발산", "급수"),
)
