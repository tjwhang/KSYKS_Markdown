...
#let setup-rules(body) = {
    // [A] 기본 텍스트
    set text(size: 10pt, font: font-main, cjk-latin-spacing: none, lang: "ko", region: "KR")
    ...
    show math.equation: set text(
        font: (
            ...
            *   **포함 기호:** $\partial$ (편미분), $\nabla$, $\Delta$, $\infty$, $\int$ (적분), $\iint$, $\iiint$, $\oint$
            ...
            (name: "tex gyre termes math", covers: regex("[𝐴𝐵𝐶𝐷𝐸𝐹𝐺𝐻𝐼𝐽𝐾𝐿𝑀𝑁𝑂𝑃𝑄𝑅𝑆𝑇 𝑈𝑉𝑊𝑋𝑌𝑍]")),
            (name: "xits math", covers: regex("[a-zA-Z \u{1D434}-\u{1D467} \u{210E} ℎℏ]")), // normal latin
            ...
            (
                ...
                covers: regex(
                    "[ \\+ \\-−=×÷±∓∗/%<>≤≥≠≈≡∝  \u{2295}-\u{229A}\u{2218}\u{22C6}\u{22C5} \u{2200}-\u{220B}\u{2223}-\u{222A}\u{2282}-\u{228B}\u{2227}\u{2228}\u{2201}-\u{2204}]",
                ),
            ), // operators
            (name: "STIX Two Math"),
            (name: "KoPubBatang_Pro", covers: regex("[\p{scx:Hangul}+]")),
